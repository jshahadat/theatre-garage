...
const Navbar = () => {
    ...
    return (
        ...
        //                                 <li ><button title={user?.displayName} onClick={handleLogOut} >Log out</button></li>
        //                             </>
        //                             :
        //                             <>
        //                                 <li>
        ...
        //                             <li> <Link to='/dashboard' >Dashboard</Link></li>
        //                             {/* <li> <Link to='/addproduct' > Add A Product</Link></li> */}
        //                             <li title={user?.displayName}><button onClick={handleLogOut} >Log out</button></li>
        ...
        <div className='lg:pl-20 lg:pr-20'>
            <div className="navbar bg-base-100 flex justify-between">
                <div className="navbar-start">
                    ...
                    <Link to="/" className="btn btn-ghost normal-case text-xl">Old Is Gold</Link>
                </div>
                <div className="navbar-center hidden lg:flex">
                    <ul className="menu menu-horizontal p-0">
                        {menuItems}
